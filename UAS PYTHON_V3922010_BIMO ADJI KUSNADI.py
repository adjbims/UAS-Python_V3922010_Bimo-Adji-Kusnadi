...
web_url = 'https://www.bukalapak.com/c/komputer/aksesoris-226?page=' # Menyimpan link web bukalapak yang akan discraping ke variabel.
...
csv_file = 'data_aksesoriskomputer.csv'  # Deklarasi nama file CSV untuk menyimpan data.
...
data = pd.read_csv("data_aksesoriskomputer.csv")
